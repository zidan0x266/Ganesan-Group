...
def main():
    ...
    trj = "../h5la/unwrap.xtc"
    pst = "../h5la/pils.h5"
    atp = "uta_501"  # fetch central particle
    ...
    for start in START:
        ...
        for time in range(start, tau + start + 1):
            if initialization:
                ...
                v_state = [get_prob(old, new, remains) for old, new in zip(old_sol_shell, new_sol_shell)]
    ...
    #print(travel_length)
    travelPrint('travel_length_' + str(remains) + '_' + str(tau), travel_length)
