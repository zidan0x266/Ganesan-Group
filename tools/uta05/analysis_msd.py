...
def main():
    ...
    stime = np.linspace(0, 10000, 10001)
    msd_Li = finalGetdx_i(COORDs_Li, 0, 10, 56)
    msd_TFSI = finalGetdx_i(COORDs_TFSI, 0, 10, 56)
    msdPrint('msd_m', stime, msd_Li)
    msdPrint('msd_a', stime, msd_TFSI)
