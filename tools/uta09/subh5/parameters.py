...
def _args_analysis():
    ...
    parser.add_argument('--func', type=str, default='subh5', choices=['subh5', 'aacf'],
                        help='job type: subh5 - associations in sub-domains ' +
    ...
    parser.add_argument('--cutoff', type=float, help='cutoff for association')
    parser.add_argument('--Icutoff', type=float, help='cutoff for the interface')
    parser.add_argument('--anion', help='reference ion selection')
    parser.add_argument('--cation', help='selection ion selection')
    parser.add_argument('--concentration', help='lithium salt concentration')
    parser.add_argument('--Dxyz', type=int, help='norm of conductive domain')
